 sudo qemu-system-x86_64 -vnc :14 \
		-enable-kvm -smp 8 -m 16384 \
		-drive file=/home/chix/kvm/image/image-14.img,if=virtio \
		-net nic,macaddr=00:00:00:00:10:14,vlan=1 \
		...
		-net nic,macaddr=00:00:00:00:11:14,vlan=2 \
