 sudo qemu-system-x86_64 -vnc :20 \
		-enable-kvm -smp 8 -m 16384 \
		-drive file=/home/chix/kvm/image/image-20.img,if=virtio \
		-net nic,macaddr=00:00:00:00:10:20,vlan=1 \
		...
		-net nic,macaddr=00:00:00:00:11:20,vlan=2 \
