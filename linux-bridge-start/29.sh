 sudo qemu-system-x86_64 -vnc :29 \
		-enable-kvm -smp 8 -m 16384 \
		-drive file=/home/chix/kvm/image/image-29.img,if=virtio \
		-net nic,macaddr=00:00:00:00:10:29,vlan=1 \
		...
		-net nic,macaddr=00:00:00:00:11:29,vlan=2 \
