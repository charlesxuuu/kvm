 sudo qemu-system-x86_64 -vnc :21 \
		-enable-kvm -smp 8 -m 16384 \
		-drive file=/home/chix/kvm/image/image-21.img,if=virtio \
		-net nic,macaddr=00:00:00:00:10:21,vlan=1 \
		...
		-net nic,macaddr=00:00:00:00:11:21,vlan=2 \
