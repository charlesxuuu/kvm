 sudo qemu-system-x86_64 -vnc :34 \
		-enable-kvm -smp 8 -m 16384 \
		-drive file=/home/chix/kvm/image/image-34.img,if=virtio \
		-net nic,macaddr=00:00:00:00:10:34,vlan=1 \
		...
		-net nic,macaddr=00:00:00:00:11:34,vlan=2 \
